...
async def add_to_initiative(channel_id: str | int, player_name: str, initiative: int):
    """Adds a character to an initiative tracker."""
    pass


async def remove_from_initiative(channel_id: str | int, player_name: str):
    """Removes a character from an initiative tracker."""
    pass


async def update_initiative(channel_id: str | int, player_name: str, initiative: int):
